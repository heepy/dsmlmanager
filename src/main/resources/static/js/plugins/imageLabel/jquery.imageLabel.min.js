            ...
            if (b) {
                ...
                o.y < o.ey ? (i.y = o.y, i.ey = o.ey) : (i.y = o.ey, i.ey = o.y),
                 s.attr("data-json", JSON.stringify($.extend(o, i))),
                  Math.abs(a.clientX - t.cx) > 10 && Math.abs(a.clientY - t.cy) > 10 && !p && !v ? (n.editPop && ($(".imageLabel-input").addClass("imageLabel-active").find("input").val(""), setTimeout(function() { $(".imageLabel-input").find("input").focus()[0].setSelectionRange(-1, -1) }, 500)), n.edit(s)) : p || v || s.remove(), b = !1, p = !1, v = !1, 
                e(),
